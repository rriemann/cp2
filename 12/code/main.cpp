...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        cout << "magnetization: " << magn[i]*0.0001 << endl;
        cout << "energy: " << ener[i]*0.0001 << endl;
        mean_m2 += magn[i]*magn[i]*0.0001*0.0001;
        mean_m += magn[i]*0.0001;
        mean_e2 += ener[i]*ener[i]*0.0001*0.0001;
        mean_e += ener[i]*0.0001;
    }

    cout << "σ magnetization: " << sqrt(mean_m2*0.1 - mean_m*0.01) << endl;
    cout << "σ energy: " << sqrt(mean_e2*0.1 + mean_e*0.01) << endl;	// energy negative
