...
\begin{figure}
  \centering
  \subfloat[Mittlere Energie für  Setup 1]{\label{fig:ev1}\includegraphics[width=0.5\textwidth]{../tmp/ev_1}}
  \subfloat[Mittlere Magnetisierung für Setup 1]{\label{fig:mv1}\includegraphics[width=0.5\textwidth]{../tmp/mv_1}}  \\
  \subfloat[Mittlere Energie für Setup 2]{\label{fig:ev2}\includegraphics[width=0.5\textwidth]{../tmp/ev_2}}
  \subfloat[Mittlere Magnetisierung für Setup 2]{\label{fig:m2}\includegraphics[width=0.5\textwidth]{../tmp/mv_2}}
